...
(function ($) {
    ...
    (function ($$) {
        ...
        $$.$ss_linkpad2_color_generator = $ss_linkpad2_color_generator;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//ss/linkpad2/color/color.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $ss_blocks_block.prototype, "on_arrow_right", null);
    __decorate([
        $mol_mem
    ], $ss_blocks_block.prototype, "on_arrow_left", null);
    __decorate([
        $mol_mem
    ], $ss_blocks_block.prototype, "on_arrow_up", null);
    __decorate([
        $mol_mem
    ], $ss_blocks_block.prototype, "on_arrow_down", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $ss_blocks_block.prototype, "delete_backward", null);
    __decorate([
        $mol_mem
    ...
    __decorate([
        $mol_mem
    ], $ss_blocks_block.prototype, "custom_keydown", null);
    __decorate([
        $mol_mem
...
(function ($) {
    ...
    (function ($$) {
        ...
        class $ss_blocks_block extends $.$ss_blocks_block {
            ...
            async focus(pos = 'end', ignoreDefault = false) {
                if ($mol_mem_cached(() => this.focus_state()) != 'focused')
                    this.focus_state('setting');
                const dom = this.dom_tree();
                if (dom?.parentElement?.innerText.trim() == this.value_changed().trim()
                    ...
                    if (this.value_changed() == 'default_block_value_changed' && !ignoreDefault)
                        return;
            ...
            insert_in_sel(str, collapse_to_start = false) {
                const sel = document.getSelection();
                if (sel?.rangeCount) {
...
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $ss_blocks.prototype, "focus_history_dom_ids", null);
    __decorate([
        $mol_mem
        ...
        class $ss_blocks extends $.$ss_blocks {
            constructor() {
                ...
                document.onselectionchange = (e) => {
                    const new_selected = this.block_from_sel();
            ...
            Block(id) {
                ...
                obj.add_to_focus_history = () => {
                    ...
                    this.focus_history_dom_ids([...ids, dom_id]);
                };
                return obj;
            }
...
(function ($) {
    class $ss_blocks_contenteditable extends $mol_view {
        focus_history_dom_ids() {
            return this.Blocks().focus_history_dom_ids();
        }
        Block(id) {
...
(function ($) {
    class $ss_linkpad2_link extends $mol_ghost {
        ...
        Default() {
            const obj = new this.$.$ss_linkpad2_link_default();
            obj.Link_data = (id) => this.Link_data(id);
            obj.actions = () => this.actions();
            obj.get_data = () => this.get_data();
            obj.depth = () => this.depth();
            obj.fold = (id) => this.fold(id);
            obj.folded = (next) => this.folded();
            obj.add_new_link = (id) => this.add_new_link(id);
            obj.replace = (id) => this.replace(id);
            obj.on_hovered = (id, next) => this.on_hovered(id, next);
            obj.on_focus = (id) => this.on_focus(id);
        ...
        Node_label_sub() {
            return this.Node().label_sub();
        }
        node_color() {
            return this.Node().node_color();
        }
        Node() {
            const obj = new this.$.$ss_linkpad2_link_node();
            obj.Link_data = (id) => this.Link_data(id);
            obj.actions = () => this.actions();
            obj.get_data = () => this.get_data();
            obj.depth = () => this.depth();
        ...
        Root() {
            const obj = new this.$.$ss_linkpad2_link_root();
            obj.Link_data = (id) => this.Link_data(id);
            obj.actions = () => this.actions();
            obj.get_data = () => this.get_data();
            obj.depth = () => this.depth();
        ...
        Loop() {
            const obj = new this.$.$ss_linkpad2_link_loop();
            obj.Link_data = (id) => this.Link_data(id);
            obj.actions = () => this.actions();
            obj.get_data = () => this.get_data();
            obj.depth = () => this.depth();
    ...
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link.prototype, "only_nodes", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link.prototype, "folded", null);
    __decorate([
        $mol_mem_key
    ], $ss_linkpad2_link.prototype, "on_hovered", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link.prototype, "hide_contain", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link.prototype, "all_link_ids", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link.prototype, "Default", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link.prototype, "Node", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link.prototype, "Root", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link.prototype, "Loop", null);
    $.$ss_linkpad2_link = $ss_linkpad2_link;
})($ || ($ = {}));
//ss/linkpad2/link/-view.tree/link.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $ss_linkpad2_link_data extends $mol_store {
        id(next) {
        ...
        to_id(next) {
            return this.value('to_id', next);
        }
        out(next) {
            return this.value('out', next) ?? [];
        }
        val(next) {
    ...
    $.$ss_linkpad2_link_data = $ss_linkpad2_link_data;
})($ || ($ = {}));
//ss/linkpad2/link/data/data.view.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        function $ss_linkpad2_link_ui_id_build(link_id, parent_ui_id = null) {
            return [parent_ui_id, link_id];
        }
        $$.$ss_linkpad2_link_ui_id_build = $ss_linkpad2_link_ui_id_build;
        function $ss_linkpad2_link_id_from_ui(ui_id) {
            return ui_id[1];
        }
        $$.$ss_linkpad2_link_id_from_ui = $ss_linkpad2_link_id_from_ui;
        function $ss_linkpad2_link_id_parent_from_ui(ui_id) {
            return ui_id[0]?.[1];
        }
        $$.$ss_linkpad2_link_id_parent_from_ui = $ss_linkpad2_link_id_parent_from_ui;
        class $ss_linkpad2_link extends $.$ss_linkpad2_link {
            ...
            ui_type() {
                if (this.to_link())
                    return this.data().from_id() == this.data().to_id() ? 'loop' : 'default';
                return this.ui_id()[0] == null ? 'root' : 'node';
            }
            Sub() {
        ...
        __decorate([
            $mol_mem
        ], $ss_linkpad2_link.prototype, "to_link", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2_link.prototype, "ui_type", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2_link.prototype, "Sub", null);
        $$.$ss_linkpad2_link = $ss_linkpad2_link;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//ss/linkpad2/link/link.view.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $ss_linkpad2_scroll extends $mol_scroll {
        event() {
            return {
                ...
                touchmove: (next) => this.event_touchmove(next)
            };
        }
        event_wheel(next) {
            if (next !== undefined)
    ...
    __decorate([
        $mol_mem
    ], $ss_linkpad2_scroll.prototype, "event_wheel", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_scroll.prototype, "event_touchmove", null);
    $.$ss_linkpad2_scroll = $ss_linkpad2_scroll;
})($ || ($ = {}));
//ss/linkpad2/scroll/-view.tree/scroll.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    class $ss_linkpad2 extends $mol_view {
        color_gen() {
            const obj = new this.$.$ss_linkpad2_color_generator();
            return obj;
        }
        raw_gql_path(next) {
            if (next !== undefined)
        ...
        Blocks() {
            return this.Contenteditable().Blocks();
        }
        focus_history_dom_ids() {
            return this.Contenteditable().focus_history_dom_ids();
        }
        Contenteditable() {
            const obj = new this.$.$ss_blocks_contenteditable();
            obj.Body = () => this.Root_link();
            return obj;
        }
        ...
        outline_sel_ui_id(next) {
            if (next !== undefined)
                return next;
            return null;
        }
        Link(id) {
            const obj = new this.$.$ss_linkpad2_link();
            obj.actions = () => this.actions();
            obj.get_data = () => this.get_data();
            obj.folded = (next) => this.folded(id);
            obj.fold = (id) => this.fold(id);
            obj.Link_data = (id) => this.Link_data(id);
            obj.add_new_link = (id) => this.add_new_link(id);
            obj.replace = (id) => this.replace(id);
        ...
        Lines() {
            const obj = new this.$.$ss_linkpad2_scroll();
            obj.sub = () => [
                this.Page_row()
            ];
            obj.event_wheel = (next) => this.event_wheel(next);
            obj.event_touchmove = (next) => this.event_wheel(next);
            return obj;
        }
        Root_link(next) {
            if (next !== undefined)
    ...
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "color_gen", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "raw_gql_path", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "right_link_id", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "Contenteditable", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "Contenteditable_package", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "all_link_ids", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "outline_sel_ui_id", null);
    __decorate([
        $mol_mem_key
    ], $ss_linkpad2.prototype, "Link", null);
    __decorate([
        $mol_mem_key
    ], $ss_linkpad2.prototype, "link_links_id", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "Float_line", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "Page_row", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "event_wheel", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "Lines", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "Root_link", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "Root_package_link", null);
    __decorate([
        $mol_mem_key
    ], $ss_linkpad2.prototype, "folded", null);
    __decorate([
        $mol_mem_key
    ], $ss_linkpad2.prototype, "on_hovered", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2.prototype, "hide_contain", null);
    $.$ss_linkpad2 = $ss_linkpad2;
})($ || ($ = {}));
//ss/linkpad2/-view.tree/linkpad2.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
var $;
(function ($) {
    class $ss_linkpad2_lib_deep {
        static deepBundle() {
            $mol_wire_solid();
            const { makeDeepClient, minilinks } = require('../ss/linkpad2/lib/deep/main.bundle.js');
    ...
    __decorate([
        $mol_mem
    ], $ss_linkpad2_lib_deep, "deepBundle", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_lib_deep, "gql_path", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_lib_deep, "deep", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_lib_deep, "minilinks", null);
    $.$ss_linkpad2_lib_deep = $ss_linkpad2_lib_deep;
})($ || ($ = {}));
//ss/linkpad2/lib/deep/deep.ts
;

var $node = $node || {}
void function( module ) { var exports = module.exports = this; function require( id ) { return $node[ id.replace( /^.\// , "../ss/linkpad2/lib/deep/" ) ] }; 
;
...
$node[ "../ss/linkpad2/lib/deep/main.bundle" ] = $node[ "../ss/linkpad2/lib/deep/main.bundle.js" ] = module.exports }.call( {} , {} )
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    ...
    const block_width_vw = 80;
    const block_width_max_px = block_width_vw * 8;
    $.$ss_linkpad2_theme = {
        block_width_vw,
        block_width: vary('--ss_linkpad2_theme_block_width', `min(${block_width_vw}vw, ${block_width_max_px}px)`),
        block_padding: vary('--ss_linkpad2_theme_block_width', `min(${block_width_vw / 10}vw, ${block_width_max_px / 10}px)`),
        block_width_px: () => {
            const w = document.documentElement.clientWidth;
            const block_w = w * block_width_vw / 100;
            return Math.min(block_w, block_width_max_px);
        },
    };
})($ || ($ = {}));
//ss/linkpad2/theme/theme.ts
;
"use strict";
var $;
(function ($) {
...
(function ($) {
    var $$;
    (function ($$) {
        class $ss_linkpad2 extends $.$ss_linkpad2 {
            static block_width_vw = 80;
            typeLinks = new Set();
            ui_id(id) {
                return id;
            }
            ...
            Type_link() {
                $mol_wire_solid();
                const Type_id = 'Type';
                const data = this.Link_data(Type_id, new $ss_linkpad2_link_data({ id: Type_id, type_id: '0_0', out: [] }));
                data.name('Type');
                return data;
            }
            Contain_link() {
            ...
            depth(ui_id) {
                $mol_wire_solid();
                let depth = 0;
                const parent_depth = $mol_mem_cached(() => this.depth(ui_id?.[0] ?? null));
            ...
            to_link_id(ui_id, next) {
                if (ui_id)
                    return this.Link_data(ui_id[1])?.to_id(next) ?? null;
                return null;
            }
            to_link(ui_id) {
                const id = this.to_link_id(ui_id);
                if (!id)
                    return null;
                const to_ui_id = $ss_linkpad2_link_ui_id_build(id, ui_id);
                return this.Link(to_ui_id);
            }
            link_links_id(ui_id, next) {
                if (ui_id)
                    return this.Link_data(ui_id[1])?.out(next) ?? [];
                return [];
            }
            add_DEV(type_id, name_or_val, parent_ui_id, node) {
                const id = this.guid();
                const ui_id = $ss_linkpad2_link_ui_id_build(id, parent_ui_id);
                if (node) {
                    this.to_link_id(parent_ui_id, ui_id[1]);
                    const data = this.Link_data(id, new $ss_linkpad2_link_data({ id, type_id, hue: this.color_gen().get_next_hue(), out: [] }));
                }
                else {
                    const parent_link_id = parent_ui_id ? $ss_linkpad2_link_id_from_ui(parent_ui_id) : undefined;
                    const data = this.Link_data(id, new $ss_linkpad2_link_data({ id, type_id, from_id: parent_link_id, hue: this.color_gen().get_next_hue(), out: [] }));
                }
            ...
            add_undef(name_or_val, parent_ui_id, node) {
                ...
                const type_id = this.Type_link_id();
                if (node) {
                    const from_id = parent_ui_id ? $ss_linkpad2_link_id_from_ui(parent_ui_id) : undefined;
                    this.to_link_id(parent_ui_id, ui_id[1]);
                    const data = this.Link_data(id, new $ss_linkpad2_link_data({ id, type_id, from_id, hue: this.color_gen().get_next_hue(), out: [] }));
                }
                else {
                    const data = this.Link_data(id, new $ss_linkpad2_link_data({ id, type_id, hue: this.color_gen().get_next_hue(), out: [] }));
                }
            ...
            push_link(args) {
                const { parent, link, pos } = args;
                const links = [...this.link_links_id(parent)];
                if (pos === undefined) {
                    this.link_links_id(parent, [...links, link[1]]);
                }
                else {
                    this.link_links_id(parent, [...links.slice(0, pos), link[1], ...links.slice(pos)]);
                }
            }
            add_new_link(args) {
                ...
                this.push_link({ parent: from, link, pos });
            ...
            replace(args) {
                ...
                if (new_id) {
                    ...
                    return $ss_linkpad2_link_ui_id_build(new_id, parent_ui_id);
                }
                else if (new_to) {
                    this.to_link_id(parent_ui_id, new_to[1]);
                    return new_to;
                }
                else if (new_type_id) {
                    const old_link = this.Link(ui_id);
                    const id = this.guid();
                    const data = this.Link_data(id, new $ss_linkpad2_link_data({
                        id,
                        type_id: new_type_id,
                    ...
                    const new_ui_id = $ss_linkpad2_link_ui_id_build(id, parent_ui_id);
                    const to_link = this.to_link(ui_id);
                    if (to_link) {
                        const to_link_id = to_link.ui_id()[1];
                        const new_to_link_ui_id = $ss_linkpad2_link_ui_id_build(to_link_id, new_ui_id);
                        this.to_link_id(new_ui_id, new_to_link_ui_id[1]);
                    }
                    const links = [...this.link_links_id(parent_ui_id)];
                    const ind = links.findIndex(id => id == old_id);
                    if (ind != -1) {
                        ...
                        this.to_link_id(parent_ui_id, new_ui_id[1]);
                    }
                    return new_ui_id;
                }
            }
            ...
            deep() {
                $ss_linkpad2_lib_deep.gql_path(this.gql_path());
                return this.gql_path() ? $ss_linkpad2_lib_deep.deep() : null;
            }
            minilinks(data) {
                $mol_wire_solid();
                return data ? $ss_linkpad2_lib_deep.minilinks()(data) : null;
            }
            sync_deep() {
            ...
            addL = (L, parent_ui_id, node) => {
                ...
                if (!this.Link_data(L.type.id + ''))
                    this.Link_data(L.type.id + '', new $ss_linkpad2_link_data({
                        id: L.type.id + '',
                ...
                if (parent_ui_id) {
                    if (node) {
                        from_id = $ss_linkpad2_link_id_from_ui(parent_ui_id);
                        this.to_link_id(parent_ui_id, ui_id[1]);
                    }
                    else {
                        this.push_link({ parent: parent_ui_id, link: ui_id });
                    }
                }
                if (!this.Link_data(id))
                    this.Link_data(id, new $ss_linkpad2_link_data({
                        id,
                        type_id: L.type_id + '',
                        from_id,
                        hue: this.color_gen().get_next_hue(),
            ...
            add_root_L(L, depth) {
                const root_ui_id = this.addL(L, null);
                const visited = new Set();
                L.out
                    .sort(this.sort_linksL).forEach(L => {
                    const ui_id = this.addL(L, root_ui_id, false);
                    const to_ui_id = this.addL(L.to, ui_id, true);
                    if (depth > 0) {
                        this.add_outL(L, ui_id, depth, visited);
                        this.add_outL(L.to, to_ui_id, depth, visited);
                    }
                });
                return root_ui_id;
            }
            Admin_page_old() {
                ...
                const Admin = this.add_root_L(AdminL, 8);
            ...
            Package_page(id) {
                ...
                if (!DeepcaseL)
                    return null;
                const Deepcase = this.add_root_L(DeepcaseL, 4);
            ...
            add_contain_with_line(parent_ui_id, v = '', pos) {
                const Contain_Line = this.add_DEV(this.Contain_type_id(), '', parent_ui_id);
                this.push_link({ parent: parent_ui_id, link: Contain_Line, pos });
                return this.add_DEV(this.Line_type_id(), v, Contain_Line, true);
            }
            add_line_loop(parent_ui_id, v = '', pos) {
                const Line = this.add_DEV(this.Line_type_id(), v, parent_ui_id);
                this.push_link({ parent: parent_ui_id, link: Line, pos });
                this.to_link_id(Line, parent_ui_id[1]);
                return Line;
            }
            Wiki_page() {
                const ml = this.ml();
                const TypeL = ml.byId[1];
                this.addL(TypeL, null);
                const RootL = ml.byId[194];
                const LineL = ml.byId[198];
                this.addL(LineL, null);
                const Root = this.addL(RootL, null);
                const visited = new Set();
                RootL.out
                    .sort(this.sort_linksL).forEach(L => {
                    const ui_id = this.addL(L, Root, false);
                    const to_ui_id = this.addL(L.to, ui_id, true);
                    this.add_outL(L, ui_id, 4, visited);
                    this.add_outL(L.to, to_ui_id, 4, visited);
                });
                const root_ui_id = $ss_linkpad2_link_ui_id_build('194');
                const add_item = (parent_ui_id, item) => {
                    const item_ui_id = this.add_contain_with_line(parent_ui_id, item.v);
                    item.kids.forEach((kid) => {
                        add_item(item_ui_id, kid);
                    });
                };
                add_item(root_ui_id, this.wiki_data());
                const RootPage = this.Link(Root);
                return RootPage;
            }
            default_data() {
                const json = $mol_fetch.json('/links-text-editor/ss/linkpad2/data/default.json');
                return json;
            }
            Root_link() {
            ...
            auto() {
                this.Root_link().links()[0].to_link().Default().Value_block().focus();
                this.scroll_x_offset();
                addEventListener("resize", (event) => this.resize(event));
            }
            resize(event) {
                const focused_id = this.focus_history_dom_ids().at(-1);
                if (focused_id) {
                    const elem = document.getElementById(focused_id);
                    const delta = this.block_overflow_offset(elem);
                    if (Math.abs(Number(delta)) < 5)
                        return;
                    if (!this.scroll_x_offset())
                        this.scroll_x_offset(delta);
                }
                return event;
            }
            all_link_ids(next) {
            ...
            link_data_by_ui_id(ui_id) {
                const link_id = $ss_linkpad2_link_id_from_ui(ui_id);
            ...
            link_links(ui_id) {
                return this.link_links_id(ui_id)
                    .map((id, index) => {
                    const link = this.Link($ss_linkpad2_link_ui_id_build(id, ui_id));
                    return link;
                });
            }
            wiki_data() {
                const item = { v: 'Википедия', kids: [
                        { v: 'Википедия (англ. Wikipedia, произносится — свободная[3] общедоступная мультиязычная универсальная интернет-энциклопедия. Расположена на интернет-сайте http://www.wikipedia.org/.', kids: [] },
                        { v: 'Владелец сайта — американская некоммерческая организация «Фонд Викимедиа», имеющая 19 региональных представительств. Название энциклопедии образовано от английских слов «wiki» (технология, лежащая в основе функционирования сайта; в свою очередь заимствовано из гавайского языка, в котором оно имеет значение «быстро») и «encyclopedia» (энциклопедия).', kids: [] },
                        { v: 'Главной особенностью интернет-энциклопедии Википедия (благодаря технологии wiki, лежащей в основе функционирования сайта) является то, что создавать и редактировать её статьи может, в принципе, каждый пользователь сети интернет, причём даже без регистрации на сайте энциклопедии. Все вносимые таким добровольцем в какую-либо статью этой энциклопедии изменения незамедлительно становятся видными всем посетителям сайта.', kids: [] },
                        { v: 'Википедия ведётся добровольцами со всего мира на 270 мировых языках. Она содержит более 18 миллионов[1] статей. Интернет-сайт Википедии является пятым по посещаемости сайтом в мире — его посещают 400 миллионов человек в месяц[4]. Запущенная в январе 2001 года Джимми Уэйлсом и Ларри Сэнгером[5] Википедия сейчас является самым крупным и наиболее популярным[6] справочником в Интернете[7][8][9]. По объёму сведений и тематическому охвату Википедия считается самой полной энциклопедией из когда-либо создававшихся за всю историю человечества[10][11][12]. Одним из основных достоинств Википедии как универсальной энциклопедии является возможность представления информации на родном языке пользователя, сохраняя, таким образом, ценность этой информации в аспекте культурной принадлежности[13].', kids: [] },
                        { v: 'Надёжность и точность Википедии вызывают вопросы[14]. Другая критика указывает на подверженность Википедии вандализму, а также добавлению ложной или непроверенной информации[15]. Однако научные исследования свидетельствуют о том, что в Википедии следы актов вандализма обычно оперативно устраняются[16][17].', kids: [] },
                        { v: 'Помимо выполнения функции энциклопедического справочника, Википедия стала главным объектом внимания СМИ как сетевой источник последних новостей по причине того, что она постоянно обновляется[18][19]. Когда популярный американский еженедельник «Time» признал некого абстрактного представителя миллионов вкладчиков пользовательского контента в различные сайты, носящего обобщённое имя You, «Человеком года» 2006, тем самым отмечая ускоряющийся успех онлайн-сотрудничества и взаимодействия миллионов интернет-пользователей по всему миру, Википедия была первым часто упоминающимся проектом Веб 2.0, за которым следовали проекты YouTube и MySpace[20].', kids: [] },
                        { v: 'В настоящее время существует 270 языковых разделов Википедии. Русская Википедия (то есть, раздел Википедии на русском языке) занимает 8 место по количеству статей среди всех языковых разделов Википедии (после английской, немецкой, французской, итальянской, польской, испанской и японской Википедий), имея на сегодняшний день в своём составе 727 737 статей.', kids: [] },
                        { v: 'В 2008 году два исследования теоретически предсказали, что рост Википедии является устойчивым[21].', kids: [] },
                        { v: 'Сущность Википедии', kids: [
                                { v: 'Википедия — свободная[3] общедоступная мультиязычная универсальная интернет-энциклопедия. Может быть полезной самому широкому кругу читателей — от школьников до докторов наук. Пишется и редактируется добровольцами — всеми желающими пользователями всемирной сети интернет на 270 мировых языках, причём без какой бы то ни было премодерации. Соответственно, состоит из 270 языковых разделов. Русский раздел Википедии (русская Википедия) занимает 8 место по количеству статей среди всех 270 языковых разделов Википедии.', kids: [
                                        { v: 'Википедия — энциклопедия, а не толковый словарь. (Толковым словарём является её родственный проект Викисловарь).', kids: [] },
                                        { v: 'Википедия — не файловый архив. (Для размещения медиафайлов, иллюстрирующих соответствующие статьи Википедии, а также текстовых файлов, существуют её родственные проекты — Викисклад и Викитека, соответственно. Для размещения отдельных цитат из высказываний известных личностей, из художественных произведений, из кинофильмов и пр. существует её родственный проект Викицитатник.)', kids: [] },
                                        { v: 'Википедия — не место размещения новостных репортажей. (Для этого существует её родственный проект Викиновости).', kids: [] },
                                        { v: 'Википедия — не место для первичной публикации чьих бы то ни было собственных идей, теорий, исследований, изобретений, личных мнений, оценок чего бы то ни было, искусствоведческой критики и т. п.', kids: [] },
                                    ] },
                                { v: 'Краткие формулировки общепринятых правил русской Википедии можно найти на странице [1].', kids: [] },
                                { v: 'Более подробные перечни правил и руководств — на страницах [2] и [3].', kids: [] },
                            ] },
                        { v: 'Модель функционирования Википедии', kids: [
                                { v: 'В отличие от традиционных энциклопедий, таких, как Encyclopædia Britannica, ни одна статья в Википедии не проходит формального процесса экспертной оценки. Любая статья Википедии может редактироваться как с учётной записи участника, так даже и без регистрации на проекте (за исключением некоторых страниц, подверженных частому вандализму, которые доступны для изменения только определённым категориям участников или, в крайних случаях, только администраторам Википедии), и при этом все внесённые в статью изменения незамедлительно становятся видными для всех. Поэтому «Википедия не гарантирует истинность» своего содержимого[22], ведь в любом случае между моментом, когда в статью будет внесена какая-то недостоверная информация и моментом, когда эта информация будет удалена из статьи другим участником Википедии (более компетентным в данной области знания), пройдёт определённое время. (Естественно, для того, чтобы обнаружить и удалить из статьи явный вандализм нужно намного меньше времени, чем для того, чтобы освободить статью от недостоверной информации, когда подобная недостоверность не является особо очевидной.)', kids: [] },
                                { v: 'Содержимое Википедии подпадает под действие законов (в частности, авторского права) штата Флориды в США, где находятся серверы Википедии, и нескольких редакционных политик и руководств, которые призваны укрепить идею о том, что Википедия является энциклопедией.', kids: [] },
                                { v: 'Каждый вклад в Википедию должен быть по теме, являющейся энциклопедической. Тема считается энциклопедической, если она является «значимой»[23] на жаргоне Википедии, то есть, если она получила значительное освещение во вторичных авторитетных источниках (например, в центральных СМИ или серьёзных научных журналах), которые являются независимыми от предмета темы.', kids: [] },
                                { v: 'В Википедии должна отражаться информация, которая уже установлена и признана[24]. Иными словами, статья не должна представлять, быть «площадкой» для размещения чьих бы то ни было собственных идей, теорий, исследований, изобретений, личных мнений, оценок чего бы то ни было, искусствоведческой критики и т. п. Информация в статьях, которая, скорее всего, будет поставлена под сомнение, требует ссылок на авторитетные источники. Сообщество Википедии сформулировало это как «проверяемость, а не истина», выражая тем самым ту мысль, что читателям предоставляется возможность самим проверить истинность той информации, которая представлена в статьях, и сделать свои собственные выводы[25].', kids: [] },
                                { v: 'Википедия не становится на чью-либо сторону[26]. В рамках статьи Википедии должны иметь соответствующую долю освещения все мнения и точки зрения по данному вопросу, если они имеют свои подтверждения во внешних источниках[27].', kids: [] },
                                { v: 'Все участники, зарегистрированы они на проекте или нет, могут пользоваться функциями программного обеспечения, на котором работает Википедия. Так на странице «История», прилагающейся к каждой статье Википедии, доступны записи каждой предыдущей редакции статьи (но версии с угрозами криминального характера, нарушениями авторских прав, могут быть удалены[28].) Эта функция позволяет легко сравнить нынешнюю и более старые версии статьи, отменить изменения («откатить статью»), которые участник посчитает неверными, или восстановить потерянное содержимое. Страница «Обсуждение», прилагающаяся к каждой статье Википедии, используется в целях координации работы над текстом этой статьи между разными участниками проекта[29]. Постоянные участники нередко используют «Список наблюдения», в который заносят интересные для себя статьи, и, таким образом, могут легко отслеживать все недавние изменения в этих статьях. Компьютерные программы, называемые ботами, в Википедии широко используются для удаления вандализма, как только он был произведён[17], а также чтобы исправить общие ошибки и стилистические проблемы или начать такие статьи, как статьи о географических объектах в стандартном формате из статистических данных.', kids: [] },
                            ] },
                        { v: 'Критика Википедии', kids: [
                                { v: 'Как и любой глобальный проект, Википедия не лишена недостатков.', kids: [] },
                                { v: 'Прежде всего необходимо отметить, что информация, тексты Википедии объективно подвержены системным отклонениям.', kids: [] },
                                { v: 'Основные объекты критики Википедии', kids: [
                                        { v: 'открытая природа проекта Википедия', kids: [] },
                                        { v: 'неавторитетность и ненадёжность информации в Википедии', kids: [] },
                                        { v: 'сохраняющиеся перекосы в охвате тем и субъективность их освещения', kids: [] },
                                        { v: 'недостаточно эффективная работа сообщества участников проекта по устранению имеющихся в настоящее         время в ней возможностей для         давления администраторов         Википедии на обычных участников         проекта, и так называемого         «административного произвола»', kids: [] },
                                    ] },
                                { v: 'Критики Википедии указывают на то, что участники Википедии совместно пишут и пересматривают её правила, политики и руководства[31] а затем, зачастую чисто формально и очень негибко их придерживаясь, удаляют, аннотируя тегами комментариев, или изменяют материалы статей, формально не отвечающие этим правилам, политикам и руководствам. (См. также удализм и инклюзионизм[32][33].)', kids: [] },
                                { v: 'Сообщество Википедии было также описано как «подобное культу»[34], хотя и не всегда с исключительно негативной коннотацией[35] и было раскритиковано за провал привлечения неопытных пользователей[36].', kids: [] },
                                { v: 'Также критики Википедии обращают внимание на системную предвзятость, несбалансированность в освещении тем[37], а также критикуют её политику предпочтения консенсуса между участниками профессионализму отдельных участников в редакционном процессе[38].', kids: [] },
                                { v: 'Открытый характер модели редактирования является центральным для большой части критики Википедии. Например, исходя из этого, можно упрекать Википедию в том, что читатель статьи не может быть уверен без ознакомления со страницей её «истории», была ли вандализирована эта статья? Критики утверждают, что редактирование статей неэкспертами подрывает качество представленного в статье материала. Поскольку участники обычно, как правило, переписывают или редактируют отдельные небольшие части статьи, а не всю её целиком, высоко- и низкокачественные материалы могут идти вперемешку в пределах одной статьи. Историк Рой Розенцвейг отметил: «В целом, написание является „ахиллесовой пятой“ Википедии. Комитеты редко пишут хорошо, и статьи Википедии часто имеют изменчивое качество, что является результатом связывания вместе предложений или абзацев, написанных разными людьми»[39]. Всё это привело к вопросу о надёжности Википедии в качестве источника достоверной информации.', kids: [] },
                                { v: 'Модель Википедии позволяет редактировать её статьи всем желающим и полагается на большую группу благонамеренных редакторов в преодолении проблем, вызванных сомнительными редакторами. Она полагается на то, что подавляющее большинство участников Википедии предполагает добрые намерения. Модели редактирования Википедии свойственна возможность добавления низкокачественной информации. Возможность анонимного редактирования может быть не только большим благом для проекта, но и источником некоторого вреда.', kids: [] },
                                { v: 'Википедия может подвергаться воздействию вандалов. Вандализм в Википедии — явно вредительское добавление, удаление или изменение содержания, совершённое умышленно в целях скомпрометировать достоверность и авторитетность энциклопедии. В основном вандализм проявляется в замене содержимого статей Википедии на ругательства, граффити, заведомо ложные данные или другое содержимое, абсолютно не имеющее отношения к теме статьи. В случаях множественного вандализма к некоторым страницам Википедии может быть применена защита.', kids: [] },
                                { v: 'Являясь общедоступным интернет-справочником, Википедия также содержит материалы, которые другие участники Википедии могут признать нежелательными, оскорбительными или порнографическими[40][41]. Например, в 2008 году Википедия отклонила массовое онлайн-обращение против включения изображения Мухаммеда в её английский раздел, сославшись на свою редакционную политику. Наличие в Википедии материалов, «неудобных» с политической точки зрения, также побудило КНР заблокировать доступ к части Википедии для китайских пользователей[42]. (См. также Блокирование Википедии британской организацией Internet Watch Foundation.)', kids: [] },
                                { v: 'Однако, в свободной энциклопедии Википедия (свободной как с точки зрения редактирования её статей, так и с точки зрения возможности внесения предложений по редактированию её нынешних правил) существуют некие механизмы саморегуляции, которые, опираясь на глобальный консенсус большинства участников Википедии, обеспечивают постоянное поддержание достаточно низкого уровня отдельных отрицательных аспектов, всегда присутствующих в Википедии.', kids: [] },
                                { v: 'Сообщество Википедии открыто для критики, и само является достаточно самокритичным. (См. [4])', kids: [] },
                                { v: 'См. также статью Википедия: ответы на критику.', kids: [] },
                            ] },
                    ] };
                return item;
            }
            ...
            on_focus_folded(ui_id) {
                const block_dom_id = JSON.stringify([ui_id, 'value']);
                const block = this.Block([ui_id, 'value']);
                let prev_focused_correction = 0;
                const prev_focused_dom_id = this.focus_history_dom_ids().at(-2);
                if (prev_focused_dom_id) {
                    const prev_focused = document.getElementById(prev_focused_dom_id);
                    if (block.dom_node_actual().offsetTop > prev_focused.offsetTop) {
                        const height = prev_focused.getBoundingClientRect().height;
                        prev_focused_correction = height - 24;
                    }
                }
                const top = block.dom_node_actual().getBoundingClientRect().top;
                const height = block.dom_node_actual().getBoundingClientRect().height;
                const desired_client_top = document.documentElement.clientHeight * 0.3;
                const next_top = desired_client_top - height / 2;
                const delta = this.block_overflow_offset(block.dom_node_actual());
                if (!this.scroll_x_offset())
                    this.scroll_x_offset(delta);
            }
            fold(ui_id) {
                const parent_ui_id = ui_id[0][0];
                const links = this.link_links_id(parent_ui_id);
                let top_sum = 0;
                let stop_sum = false;
                const node_ui_ids = links.map((id, index) => {
                    const link_ui_id = $ss_linkpad2_link_ui_id_build(id, parent_ui_id);
                    const node = this.to_link(link_ui_id);
                    const node_ui_id = node.ui_id();
                    if (node_ui_id == ui_id)
                        stop_sum = true;
                    if (!stop_sum)
                        top_sum += node.dom_node_actual().getBoundingClientRect().height - 24;
                    this.folded(node_ui_id, true);
                    return node_ui_id;
                });
                this.Lines().dom_node().scrollTop -= top_sum;
            }
            on_focus(ui_id) {
                const block_dom_id = JSON.stringify([ui_id, 'value']);
                if (this.auto_focused_block == block_dom_id)
                    return;
                this.auto_focused_block = null;
                const block = this.Block([ui_id, 'value']);
                const bounding = block.dom_node_actual().getBoundingClientRect();
                const height = bounding.height;
                const desired_client_top = document.documentElement.clientHeight * 0.3;
                const new_top = bounding.top - desired_client_top + height / 2;
                const delta_y = new_top;
                this.scroll_y_offset(delta_y);
                const delta_x = this.block_overflow_offset(block.dom_node_actual());
                this.scroll_x_offset(delta_x);
            }
            block_overflow_offset(elem) {
                const rect = elem?.getBoundingClientRect();
                if (!rect)
                    return;
                const w = document.documentElement.clientWidth;
                const padding = (w - $ss_linkpad2_theme.block_width_px()) / 2;
                const to_left = rect.left - padding;
                const to_right = rect.right - w + padding;
                const delta = Math.max(to_right, 0) + Math.min(to_left, 0);
                return delta;
            }
            block_id(dom_id) {
                return JSON.parse(dom_id);
            }
            auto_focused_block = null;
            auto_scroll() {
                if (this.scrolled)
                    new $mol_after_timeout(300, () => this.auto_scroll());
                const x = document.documentElement.clientWidth * .5;
                const y = document.documentElement.clientHeight * .3;
                let block_dom_id;
                const from_point = document.elementFromPoint(x, y);
                if (from_point?.tagName == 'SS_BLOCKS_BLOCK') {
                    block_dom_id = from_point.id;
                }
                else if (from_point?.tagName == 'SS_BLOCKS_NOEDIT') {
                    block_dom_id = from_point.dataset.blockId;
                }
                else {
                    const child = from_point?.childNodes.item(1)?.firstChild;
                    if (from_point?.tagName == 'SS_BLOCKS_BLOCK') {
                        block_dom_id = child.id;
                    }
                }
                if (!block_dom_id)
                    return;
                const block = this.Block(this.block_id(block_dom_id));
                if (!block.focused()) {
                    this.auto_focused_block = block_dom_id;
                    block.focus();
                }
                const offset = this.block_overflow_offset(block.dom_node());
                if (Math.abs(Number(offset)) < 5)
                    return;
                this.scroll_x_offset(offset);
            }
            scroll_y_offset(offset) {
                $mol_wire_solid();
                if (!offset)
                    return 0;
                const offset_abs = Math.abs(offset);
                const step = Math.max(offset_abs / 30, 10);
                const dt = Math.sign(offset) * step;
                const scroll_left_before = this.Lines().dom_node().scrollTop;
                this.Lines().dom_node().scrollTop = scroll_left_before + dt;
                const real_dt = this.Lines().dom_node().scrollTop - scroll_left_before;
                const new_offset = offset - real_dt;
                if (Math.abs(new_offset) < step) {
                    this.Lines().dom_node().scrollTop += new_offset;
                    this.scroll_y_offset(0);
                    return;
                }
                return new this.$.$mol_after_frame(() => this.scroll_y_offset(new_offset));
            }
            scroll_x_offset(offset) {
                $mol_wire_solid();
                if (!offset)
                    return 0;
                const offset_abs = Math.abs(offset);
                const step = Math.max(offset_abs / 15, 10);
                const dt = Math.sign(offset) * step;
                const scroll_left_before = this.Lines().dom_node().scrollLeft;
                this.Lines().dom_node().scrollLeft = scroll_left_before + dt;
                const real_dt = this.Lines().dom_node().scrollLeft - scroll_left_before;
                const new_offset = offset - real_dt;
                if (Math.abs(new_offset) < step) {
                    this.Lines().dom_node().scrollLeft += new_offset;
                    this.scroll_x_offset(0);
                    return;
                }
                return new this.$.$mol_after_frame(() => this.scroll_x_offset(new_offset));
            }
            scrolled = false;
            event_wheel(e) {
                if (!this.scrolled) {
            ...
            get_data() {
                return {
                    sibling_above_value: (ui_id) => {
                        const contain_ui_id = ui_id[0];
                        const parent_ui_id = contain_ui_id[0];
                        const contains = [...this.link_links_id(parent_ui_id)];
                        const contain_ind = contains.findIndex(id => id == contain_ui_id[1]);
                        if (contain_ind == 0)
                            return null;
                        const contain_above_id = contains[contain_ind - 1];
                        const contain_above_ui_id = $ss_linkpad2_link_ui_id_build(contain_above_id, parent_ui_id);
                        const line = this.to_link(contain_above_ui_id);
                        return line.data().val();
                    }
                };
            }
            actions() {
                return {
                    ...
                    new_line_sibling: (ui_id, val = '', opt) => {
                        const parent_ui_id = ui_id[0];
                        const loops = [...this.link_links_id(parent_ui_id)];
                        const shift = opt?.direction == 'below' ? 1 : 0;
                        const pos = loops.findIndex(id => id == ui_id[1]) + shift;
                        const new_line = this.add_line_loop(parent_ui_id, val, pos);
                        if (opt?.focus) {
                            this.Block([new_line, 'value']).focus('start', true);
                        }
                        return new_line;
                    },
                    new_sibling_below: (ui_id, val = '', opt) => {
                        const contain_ui_id = ui_id[0];
                        const parent_ui_id = contain_ui_id[0];
                        const contains = [...this.link_links_id(parent_ui_id)];
                        const new_contain_ind = contains.findIndex(id => id == contain_ui_id[1]) + 1;
                        const new_line = this.add_contain_with_line(parent_ui_id, val, new_contain_ind);
                        if (opt?.focus) {
                            this.Block([new_line, 'value']).focus('start', true);
                        }
                        return new_line;
                    },
                    new_sibling_above: (ui_id, val = '', opt) => {
                        const contain_ui_id = ui_id[0];
                        const parent_ui_id = contain_ui_id[0];
                        const contains = [...this.link_links_id(parent_ui_id)];
                        const new_contain_ind = contains.findIndex(id => id == contain_ui_id[1]);
                        const new_line = this.add_contain_with_line(parent_ui_id, val, new_contain_ind);
                        if (opt?.focus) {
                            this.Block([new_line, 'value']).focus('start', true);
                        }
                    ...
                    move_below_parent: (ui_id) => {
                        const contain_ui_id = ui_id[0];
                        const parent_ui_id = contain_ui_id[0];
                        const contains = [...this.link_links_id(parent_ui_id)];
                        const contain_ind = contains.findIndex(id => id == contain_ui_id[1]);
                        const upper_contain_ui_id = parent_ui_id[0];
                        if (!upper_contain_ui_id)
                            return;
                        const upper_parent_ui_id = upper_contain_ui_id[0];
                        const upper_contains = [...this.link_links_id(upper_parent_ui_id)];
                        const upper_contain_ind = upper_contains.findIndex(id => id == upper_contain_ui_id[1]);
                        const new_parent_line = this.Link(upper_parent_ui_id);
                        const new_contain = this.add_DEV(this.Contain_type_id(), '', new_parent_line.ui_id());
                        this.push_link({ parent: new_parent_line.ui_id(), link: new_contain, pos: upper_contain_ind + 1 });
                        const new_ui_id = $ss_linkpad2_link_ui_id_build(ui_id[1], new_contain);
                        this.to_link_id(new_contain, ui_id[1]);
                        this.Link(new_ui_id).Node().Value_block().focus();
                        const parent_links = [...this.link_links_id(parent_ui_id)];
                        parent_links.splice(contain_ind, 1);
                        this.link_links_id(parent_ui_id, parent_links);
                    },
                    move_inside_upper_sibling: (ui_id) => {
                        const contain_ui_id = ui_id[0];
                        const parent_ui_id = contain_ui_id[0];
                        const contains = [...this.link_links_id(parent_ui_id)];
                        const contain_ind = contains.findIndex(id => id == contain_ui_id[1]);
                        const sibling_contain_ind = contain_ind - 1;
                        if (sibling_contain_ind < 0) {
                            this.actions().new_sibling_above(ui_id);
                            this.actions().move_inside_upper_sibling(ui_id);
                            return;
                        }
                        const new_parent_contain_id = contains[sibling_contain_ind];
                        const new_parent_contain = this.Link($ss_linkpad2_link_ui_id_build(new_parent_contain_id, parent_ui_id));
                        const new_parent_line = new_parent_contain.to_link();
                        const new_contain = this.add_DEV(this.Contain_type_id(), '', new_parent_line.ui_id());
                        this.push_link({ parent: new_parent_line.ui_id(), link: new_contain });
                        const new_ui_id = $ss_linkpad2_link_ui_id_build(ui_id[1], new_contain);
                        this.to_link_id(new_contain, ui_id[1]);
                        this.Link(new_ui_id).Node().Value_block().focus();
                        const parent_links = [...this.link_links_id(parent_ui_id)];
                    ...
                    remove_sibling_above: (ui_id) => {
                        const contain_ui_id = ui_id[0];
                        const parent_ui_id = contain_ui_id[0];
                        const contains = [...this.link_links_id(parent_ui_id)];
                        const contain_above_ind = contains.findIndex(id => id == contain_ui_id[1]) - 1;
                        contains.splice(contain_above_ind, 1);
                        this.link_links_id(parent_ui_id, contains);
                    },
                };
            }
        }
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "Type_link", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "Contain_link", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "Package_link", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "Admin_link", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "depth", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "to_link_id", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "to_link", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "link_links_id", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "add_DEV", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "add_undef", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "push_link", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "add_new_link", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "replace", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "replace_to_link", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "gql_path", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "deep", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "minilinks", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "sync_deep", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "ml", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "deep_data", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "right_link_id", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "Admin_page_old", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "Package_page", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "Wiki_page", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "default_data", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "Root_link", null);
        __decorate([
        ...
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "auto", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "resize", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "all_link_ids", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "upd_link_ids", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "Link_data", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "link_data_by_ui_id", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "type_data_by_ui_id", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "link_links", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "wiki_data", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "on_hovered", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "on_focus_folded", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "fold", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "on_focus", null);
        __decorate([
            $mol_mem_key
        ], $ss_linkpad2.prototype, "block_id", null);
        __decorate([
            $mol_action
        ], $ss_linkpad2.prototype, "auto_scroll", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "scroll_y_offset", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "scroll_x_offset", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "event_wheel", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "get_data", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2.prototype, "actions", null);
        $$.$ss_linkpad2 = $ss_linkpad2;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//ss/linkpad2/linkpad2.view.ts
;
"use strict";
var $;
(function ($) {
...
//ss/linkpad2/linkpad2.view.css.ts
;
"use strict";
var $;
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_hover.prototype, "hovered", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_hover.prototype, "mouseenter", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_hover.prototype, "mouseleave", null);
    $.$ss_linkpad2_link_hover = $ss_linkpad2_link_hover;
})($ || ($ = {}));
//ss/linkpad2/link/hover/-view.tree/hover.view.tree.ts
;
"use strict";
var $;
(function ($) {
...
//ss/linkpad2/link/hover/hover.view.ts
;
"use strict";
var $;
(function ($) {
    class $ss_linkpad2_link_default extends $mol_view {
        ...
        data() {
            const obj = new this.$.$ss_linkpad2_link_data();
            return obj;
        }
        type_data() {
            const obj = new this.$.$ss_linkpad2_link_data();
        ...
        mouseenter() {
            return this.Self().mouseenter();
        }
        Self() {
            const obj = new this.$.$ss_linkpad2_link_hover();
            obj.sub = () => this.self();
            return obj;
        }
        Left_area() {
            ...
            obj.attr = () => ({
                "data-block-id": this.block_dom_id()
            });
            return obj;
        }
        Right_area() {
        ...
        event() {
            return {
                ...super.event(),
                focuslineover: (next) => this.focuslineover(next)
            };
        }
        Type() {
            const obj = new this.$.$ss_blocks_noedit();
        ...
        To_link_self() {
            return this.to_link().Node_self();
        }
        To_link_label() {
            return this.to_link().Node_label();
        }
        to_link_label_sub() {
            return this.to_link().Node_label_sub();
        }
        node_color() {
            return this.to_link().node_color();
        }
        to_link() {
            const obj = new this.$.$ss_linkpad2_link();
            return obj;
    ...
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "all_link_ids", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "hide_contain", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "data", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "type_data", null);
    __decorate([
        $mol_mem_key
    ], $ss_linkpad2_link_default.prototype, "Block", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Link_id", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Self", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Left_area", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Right_area", null);
    __decorate([
        $mol_mem_key
    ], $ss_linkpad2_link_default.prototype, "on_hovered", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Type", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Name_disabled", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Value_block", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Value", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Links", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "to_link", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "To_link", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Prefix", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Body", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "Label", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "hide_last_line", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "folded", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_default.prototype, "focuslineover", null);
    $.$ss_linkpad2_link_default = $ss_linkpad2_link_default;
})($ || ($ = {}));
//ss/linkpad2/link/default/-view.tree/default.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        class $ss_linkpad2_link_default extends $.$ss_linkpad2_link_default {
            actions() {
                throw new Error("should be overriden by $ss_linkpad2");
            }
            get_data() {
                throw new Error("should be overriden by $ss_linkpad2");
            }
            ...
            block_id() {
                return [this.ui_id(), 'value'];
            }
            block_dom_id() {
                return this.Value_block().dom_id();
            }
            Value_block() {
                const block = this.Block(this.block_id());
                block.value_changed = next => this.data().val(next);
                block.update_value(this.data().val());
                block.on_blur = () => {
                };
                block.on_focus = () => {
                    this.on_focus(this.ui_id());
                };
                block.delete_backward = (e) => {
                    const value_above = this.get_data().sibling_above_value(this.ui_id());
                    if (value_above === null)
                        return;
                    if (!(value_above == '' || value_above == '\n'))
                        block.insert_in_sel(value_above);
                    this.actions().remove_sibling_above(this.ui_id());
                };
                block.custom_keydown = (e) => {
                    if (e.key == 'Tab') {
                        e.preventDefault();
                        if (e.shiftKey) {
                            this.actions().move_below_parent(this.ui_id());
                        }
                        else {
                            this.actions().move_inside_upper_sibling(this.ui_id());
                        }
                    }
                };
                block.keydown_enter = (e) => {
                    e.preventDefault();
                    if (e.shiftKey) {
                        document.execCommand('insertLineBreak');
                        return true;
                    ...
                    document.execCommand('insertLineBreak');
                    const sel = document.getSelection();
                    let nextEl = sel?.focusNode;
                    let next = '';
                    while (nextEl) {
                        next += nextEl?.textContent;
                        nextEl = nextEl.nextSibling;
                    }
                    let prevEl = sel?.focusNode?.previousSibling;
                    let prev = '';
                    while (prevEl) {
                        prev = prevEl?.textContent + prev;
                        prevEl = prevEl.previousSibling;
                    }
                    if (prev == '' && sel?.focusOffset != 0) {
                        const temp_prev = prev;
                        prev = next;
                        next = temp_prev;
                    }
                    this.data().val(next);
                    block.update_value(next);
                    this.actions().new_sibling_above(this.ui_id(), $ss_blocks_block_trim(prev) || '\n', { focus: false });
                    block.focus('start');
                    return true;
                };
                return block;
            ...
            focused() {
                return this.Value_block().focused();
            }
            auto() {
                this.hovered();
                this.depth();
            ...
            hovered() {
                if (this.self_hovered()) {
                    const event = this.mouseenter();
                    this.on_hovered(this.ui_id(), event);
                }
                return this.self_hovered();
            }
            links_view() {
            ...
            to_link_view() {
                return this.to_link()?.links().length > 0 ? [
                    this.To_link()
                ] : [];
            }
            fold_click(next) {
                this.fold(this.ui_id());
            }
        }
        __decorate([
            $mol_mem
        ], $ss_linkpad2_link_default.prototype, "block_id", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2_link_default.prototype, "block_dom_id", null);
        __decorate([
            $mol_mem
        ], $ss_linkpad2_link_default.prototype, "hovered", null);
        $$.$ss_linkpad2_link_default = $ss_linkpad2_link_default;
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//ss/linkpad2/link/default/default.view.ts
;
"use strict";
var $;
(function ($) {
    $mol_style_attach("ss/linkpad2/link/default/default.view.css", ":root {\n\t--mol_theme_satur: 0;\n\t--mol_theme_luma: -1.05;\n}\n\n[ss_linkpad2_link_default][focused] > [ss_linkpad2_link_default_body] > [ss_linkpad2_link_default_self_node] {\n\tmax-height: fit-content;\n}\n[ss_linkpad2_link_default] > [ss_linkpad2_link_default_body] > [ss_linkpad2_link_default_self_node] {\n\t/* max-height: 1.5rem;\n\toverflow: hidden; */\n}\n\n[ss_blocks_block][focus-state=\"focused\"] {\n\tbackground: var(--mol_theme_hover);\n\tcolor: var(--mol_theme_text); \n}\n[ss_blocks_block] {\n\tcolor: gray;\n}\n[ss_blocks_block][focus-state=\"focused\"] {\n\t-webkit-background-clip: border-box;\n\t-webkit-text-fill-color: var(--mol_theme_text); \n}\n[ss_blocks_block] {\n\t/* text-indent: 1rem; */\n\twidth: var(--ss_linkpad2_block_width);\n\tbackground: linear-gradient(to right, gray 0, gray 57vw, transparent 61vw);\n\tbackground: var(--mol_theme_text);\n\toverflow: hidden;\n\tbackground: linear-gradient(to bottom, gray 0, gray 1.5rem, dimgray 1.5rem, transparent 150%);\n\t-webkit-background-clip: text;\n\t-webkit-text-fill-color: transparent; \n\tflex-shrink: 1;\n\tflex-grow: 1;\n}\n\n[ss_linkpad2_link_default][folded] {\n\theight: 1.5rem;\n}\n\n/* [ss_linkpad2_link_default]:not([has-name]) > [ss_linkpad2_link_default_body] > [ss_linkpad2_link_default_self] > [ss_linkpad2_link_default_label] > [ss_linkpad2_link_default_value] > [ss_blocks_block]::before {\n\tcontent: var(--typename);\n\tpadding-right: .5rem;\n\toverflow: hidden;\n\tbackground: var(--color);\n\t-webkit-background-clip: text;\n\t-webkit-text-fill-color: transparent; \n\topacity: 1;\n} */\n");
})($ || ($ = {}));
//ss/linkpad2/link/default/-css/default.view.css.ts
;
"use strict";
var $;
(function ($) {
    ...
    (function ($$) {
        ...
        $mol_style_define($ss_linkpad2_link_default, {
            Prefix: {
                margin: {
                    top: '.75rem',
                    left: $ss_linkpad2_theme.block_padding,
                },
                border: {
                    top: {
                        color: 'dimgray',
            ...
            Label: {
                position: 'relative',
                display: 'block',
                width: $ss_linkpad2_theme.block_width,
                maxWidth: $ss_linkpad2_theme.block_width,
                height: 'fit-content',
                gap: '.5rem',
                flex: {
                    shrink: 1,
                ...
                ":hover": {
                    background: {
                        color: $mol_style_func.hsla(0, 100, 100, 0.02),
                    }
                },
            },
            Name_disabled: {
...
//ss/linkpad2/link/default/default.view.css.ts
;
"use strict";
var $;
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_node.prototype, "Self", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_node.prototype, "Label", null);
    $.$ss_linkpad2_link_node = $ss_linkpad2_link_node;
})($ || ($ = {}));
//ss/linkpad2/link/node/-view.tree/node.view.tree.ts
;
"use strict";
var $;
(function ($) {
    $mol_style_attach("ss/linkpad2/link/node/node.view.css", "");
})($ || ($ = {}));
//ss/linkpad2/link/node/-css/node.view.css.ts
;
"use strict";
var $;
(function ($) {
    var $$;
    (function ($$) {
        const node_color = $mol_style_func.vary('--nodecolor');
        $mol_style_define($ss_linkpad2_link_node, {});
    })($$ = $.$$ || ($.$$ = {}));
})($ || ($ = {}));
//ss/linkpad2/link/node/node.view.css.ts
;
"use strict";
var $;
(function ($) {
    ...
    $.$ss_linkpad2_link_root = $ss_linkpad2_link_root;
})($ || ($ = {}));
//ss/linkpad2/link/root/-view.tree/root.view.tree.ts
;
"use strict";
var $;
(function ($) {
    ...
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_loop.prototype, "Self", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_loop.prototype, "Float", null);
    __decorate([
        $mol_mem
    ], $ss_linkpad2_link_loop.prototype, "Label", null);
    $.$ss_linkpad2_link_loop = $ss_linkpad2_link_loop;
})($ || ($ = {}));
//ss/linkpad2/link/loop/-view.tree/loop.view.tree.ts
